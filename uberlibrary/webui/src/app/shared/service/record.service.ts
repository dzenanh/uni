...
export class RecordService {
    ...
    getReviews(identifier: string) {
        return this.http
            .get('http://localhost:8080/review/get/'.concat(identifier), {headers: HttpUtil.getHeaders()})
    ...
    postReview(identifier: string, review:Review) {
        ...
        return this.http
            .put("http://localhost:8080/review/add/".concat(identifier), this.createBody(review), {headers: HttpUtil.getHeaders()})
    }
